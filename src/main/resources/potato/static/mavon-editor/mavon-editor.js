!function (e, t) {
    ...
    return function (e) {
        ...
        function u(e, t) {
            var n = 0;
            return i(A, t) ? A[t] : 35 === t.charCodeAt(0) && T.test(t) && (n = "x" === t[1].toLowerCase() ? parseInt(t.slice(2), 16) : parseInt(t.slice(1), 10), l(n)) ? c(n) : e
        }
        ...
        var w = Object.prototype.hasOwnProperty, x = /\\([!"#$%&'()*+,\-.\/:;<=>?@[\\\]^_`{|}~])/g,
            ...
            T = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))/i, A = n(52), S = /[&<>"]/, D = /[&<>"]/g,
            E = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;"}, L = /[.?*+^$[\]\\(){}|-]/g, j = n(34);
        ...
        var c = n(206), u = {}, p = l && (document.head || document.getElementsByTagName("head")[0]), d = null, h = 0,
            f = !1, _ = function () {
        ...
        var o = !1, i = n(16)(n(65), n(200), r, "data-v-548e2160", null);
        i.options.__file = "D:\\work\\songwang\\yuangongji\\mavonEditor\\src\\components\\md-toolbar-left.vue", i.esModule && Object.keys(i.esModule).some(function (e) {
        ...
        function r(e, t, n) {
            var r = u.prefix, o = u.subfix, i = n.selectionStart, a = n.selectionEnd, s = n.value,
                l = s.substring(0, i);
            l += r + e + "\n", l += t, l += o, l += s.substring(a, s.length), n.value = l, n.selectionStart = i + r.length + (e ? 0 : 1), n.selectionEnd = n.selectionStart + e.length + t.length
        }

        function o(e) {
            var t = u.prefix, n = u.subfix, r = u.defaultLanguageText, o = e.selectionStart, i = e.selectionEnd,
                a = e.value, s = a.substring(o, i);
            if ("\n" === a.substring(o - 1, o)) t += "\n"; else if (n = "\n" + n, t + r + n === a.substring(o - t.length, i + n.length)) {
                var l = a.substring(0, o - t.length);
                return l += a.substring(i + n.length, a.length), e.value = l, e.selectionStart = o - t.length, void (e.selectionEnd = e.selectionStart)
            }
            var c = a.substring(0, o - t.length);
            c += s, c += a.substring(i + n.length, a.length), e.value = c, e.selectionStart = o - t.length, e.selectionEnd = e.selectionStart + s.length
        }

        function i(e) {
            return "number" == typeof e.selectionStart && "number" == typeof e.selectionEnd
        }

        function a(e) {
            var t = e.selectionStart, n = e.selectionEnd, r = e.value, o = u.prefix, i = u.subfix;
            return "\n" === r.substring(t - 1, t) ? o += "\n" : i = "\n" + i, r.substring(t - o.length, t) === o && r.substring(n, n + i.length) === i
        }
        ...
        Object.defineProperty(t, "__esModule", {value: !0}), t.loadScript = l, t.loadLink = c;
        var u = (t.insertTextAtCaret = function (e, t, n) {
            var r = t.prefix, o = t.subfix, a = t.str;
            t.type;
            if (e.focus(), i(e)) {
                var l = e.selectionStart, c = e.selectionEnd, u = e.value;
        ...
        t.insertCodeBlock = function (e) {
            ...
            var n = u.defaultLanguageText, s = t.selectionStart, l = t.selectionEnd, c = t.value;
            if (s === l) r(n, "", t); else if (a(t)) o(t); else {
            ...
            if (i(t)) {
                ...
                if (n === r) t.value = o.substring(0, n) + "1. " + o.substring(r, o.length), t.selectionEnd = t.selectionStart = n + 3; else {
                    for (var a = n; a > 0 && "\n" !== o.substring(a - 1, a);) a--;
                    for (var s = o.substring(a, r), l = s.split("\n"), c = 0; c < l.length; c++) l[c] = c + 1 + ". " + l[c];
                    var u = l.join("\n");
                    t.value = o.substring(0, a) + u + o.substring(r, o.length), t.selectionStart = a, t.selectionEnd = r + u.length - s.length
                }
            } else alert("Error: Browser version is too low");
            e.d_value = t.value, t.focus()
            ...
            var t = e.getTextareaDom();
            if (i(t)) {
                for (var n = t.selectionStart, r = t.selectionEnd, o = t.value, a = n; a > 0 && "\n" !== o.substring(a - 1, a);) a--;
                for (var s = r; s < o.length && "\n" !== o.substring(s, s + 1);) s++;
                s < o.length && s++, t.value = o.substring(0, a) + o.substring(s, o.length), t.selectionEnd = t.selectionStart = 0 === a ? 0 : a - 1
            } else alert("Error: Browser version is too low");
            e.d_value = t.value, t.focus()
            ...
            if (i(t)) {
                ...
                if (n === r) t.value = o.substring(0, n) + "- " + o.substring(r, o.length), t.selectionEnd = t.selectionStart = n + 2; else {
                    for (var a = n; a > 0 && "\n" !== o.substring(a - 1, a);) a--;
                    var s = o.substring(a, r), l = s.replace(/\n/g, "\n- ");
                    l = "- " + l, t.value = o.substring(0, a) + l + o.substring(r, o.length), t.selectionStart = a, t.selectionEnd = r + l.length - s.length
                }
            } else alert("Error: Browser version is too low");
            e.d_value = t.value, t.focus()
            ...
            if (i(n)) {
                var r = n.selectionStart, o = n.selectionEnd, a = n.value, s = a.substring(0, r).split("\n").pop();
                if (s.match(/^\s*[0-9]+\.\s+\S*/)) {
                    var l = s.replace(/(\d+)/, 1);
                    n.value = a.substring(0, r - l.length) + t + l + a.substring(o, a.length)
                } else s.match(/^\s*-\s+\S*/) ? n.value = a.substring(0, r - s.length) + t + s + a.substring(o, a.length) : n.value = a.substring(0, r) + t + a.substring(o, a.length);
            ...
            if (i(r)) {
                var o = r.selectionStart, a = r.selectionEnd, s = r.value, l = s.substring(0, o).split("\n").pop();
                l.search(n) >= 0 && (r.value = s.substring(0, o - l.length) + l.replace(n, "") + s.substring(a, s.length), r.selectionStart = r.selectionEnd = o - (t || 1))
            } else alert("Error: Browser version is too low");
            ...
            if (i(n)) {
                ...
                if (l) {
                    ...
                    if (c.search(/-/) >= 0) n.value = a.substring(0, r) + "\n" + c + a.substring(o, a.length), n.selectionStart = n.selectionEnd = r + c.length + 1; else {
                        var u = c.replace(/(\d+)/, parseInt(c) + 1);
                        n.value = a.substring(0, r) + "\n" + u + a.substring(o, a.length), n.selectionStart = n.selectionEnd = r + u.length + 1
                    }
                } else {
                    ...
                    if (p) {
                        ...
                        n.value = a.substring(0, r - d) + "\n" + a.substring(o, a.length), n.selectionStart = n.selectionEnd = r - d
                    }
                }
            } else alert("Error: Browser version is too low");
            e.d_value = n.value, n.focus()
            ...
            function t() {
                e.$el.clientWidth > 768 ? e.s_subfield = e.subfield : e.s_subfield = !1
            }
        ...
        var r = n(1), o = n(10), i = n(85), a = n(4), s = n(2), l = function (e, t, n) {
            var c, u, p, d = e & l.F, h = e & l.G, f = e & l.S, _ = e & l.P, g = e & l.B, m = e & l.W,
                b = h ? o : o[t] || (o[t] = {}), v = b.prototype, k = h ? r : f ? r[t] : (r[t] || {}).prototype;
            h && (n = t);
            for (c in n) (u = !d && k && void 0 !== k[c]) && s(b, c) || (p = u ? k[c] : n[c], b[c] = h && "function" != typeof k[c] ? n[c] : g && u ? i(p, r) : m && k[c] == p ? function (e) {
            ...
            }(p) : _ && "function" == typeof p ? i(Function.call, p) : p, _ && ((b.virtual || (b.virtual = {}))[c] = p, e & l.R && v && !v[c] && a(v, c, p)))
        };
        ...
        "use strict";
        var r = n(12), o = n(41), i = n(48), a = n(4), s = n(21), l = n(90), c = n(24), u = n(96), p = n(7)("iterator"),
        ...
        e.exports = function (e, t, n, f, _, g, m) {
            ...
            var b, v, k, w = function (e) {
                ...
                }, x = t + " Iterator", y = "values" == _, C = !1, T = e.prototype,
                A = T[p] || T["@@iterator"] || _ && T[_], S = A || w(_), D = _ ? y ? w("entries") : S : void 0,
                E = "Array" == t ? T.entries || A : A;
            if (E && (k = u(E.call(new e))) !== Object.prototype && k.next && (c(k, x, !0), r || "function" == typeof k[p] || a(k, p, h)), y && A && "values" !== A.name && (C = !0, S = function () {
                return A.call(this)
            }), r && !m || !d && !C && T[p] || a(T, p, S), s[t] = S, s[x] = h, _) if (b = {
                values: y ? S : w("values"),
                keys: g ? S : w("keys"),
                entries: D
            }, m) for (v in b) v in T || i(T, v, b[v]); else o(o.P + o.F * (d || C), t, b);
            return b
        }
    }, function (e, t, n) {
        var r = n(9), o = n(93), i = n(20), a = n(25)("IE_PROTO"), s = function () {
            ...
            for (t.style.display = "none", n(87).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object<\/script>"), e.close(), l = e.F; r--;) delete l.prototype[i[r]];
            return l()
        };
        ...
        function r(e, t) {
            var n, r, o, i, a, s = [], l = t.length;
            for (n = 0; n < l; n++) o = t[n], 126 === o.marker && -1 !== o.end && (i = t[o.end], a = e.tokens[o.token], a.type = "s_open", a.tag = "s", a.nesting = 1, a.markup = "~~", a.content = "", a = e.tokens[i.token], a.type = "s_close", a.tag = "s", a.nesting = -1, a.markup = "~~", a.content = "", "text" === e.tokens[i.token - 1].type && "~" === e.tokens[i.token - 1].content && s.push(i.token - 1));
            for (; s.length;) {
                for (n = s.pop(), r = n + 1; r < e.tokens.length && "s_close" === e.tokens[r].type;) r++;
        ...
        function c(e, t, n, r) {
            if (n = _(n), "href" === t || "src" === t) {
                ...
                if ($.lastIndex = 0, $.test(n) && (q.lastIndex = 0, q.test(n))) return "";
        ...
        var w = n(31).FilterCSS, x = n(31).getDefaultWhiteList, y = n(35), C = new w, T = /</g, A = />/g, S = /"/g,
            D = /&quot;/g, E = /&#([a-zA-Z0-9]*);?/gim, L = /&colon;?/gim, j = /&newline;?/gim,
            q = /((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a)\:/gi,
            F = /e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi, $ = /u\s*r\s*l\s*\(.*/gi, z = /<!--[\s\S]*?-->/g;
        ...
        function i(e, t, n) {
            ...
            for (c = 0; c < u; c++) {
                ...
                if (!1 === s) {
                    ...
                    if (">" === h) {
                        i += n(e.slice(a, s)), d = e.slice(s, c + 1), p = r(d), i += t(s, i.length, p, d, o(d)), a = c + 1, s = !1;
                        continue
                    }
                    if (('"' === h || "'" === h) && "=" === e.charAt(c - 1)) {
                        l = h;
        ...
        function a(e, t) {
            ...
            for (var r = 0, o = [], i = !1, a = e.length, c = 0; c < a; c++) {
                var h, f, _ = e.charAt(c);
                if (!1 !== i || "=" !== _) if (!1 === i || c !== r || '"' !== _ && "'" !== _ || "=" !== e.charAt(c - 1)) if (/\s|\n|\t/.test(_)) {
                    if (e = e.replace(/\s|\n|\t/g, " "), !1 === i) {
                        if (-1 === (f = s(e, c))) {
                            h = p.trim(e.slice(r, c)), n(h), i = !1, r = c + 1;
                            continue
                        }
                        c = f - 1;
                        continue
                    ...
                    if (-1 === (f = l(e, c - 1))) {
                        h = p.trim(e.slice(r, c)), h = u(h), n(i, h), i = !1, r = c + 1;
                        continue
                    }
                } else ; else {
                    if (-1 === (f = e.indexOf(_, c + 1))) break;
                    h = p.trim(e.slice(r + 1, f)), n(i, h), i = !1, c = f, r = c + 1
                } else i = e.slice(r, c), r = c + 1
            }
            return r < e.length && (!1 === i ? n(e.slice(r)) : n(i, u(p.trim(e.slice(r))))), p.trim(o.join(" "))
        }
        ...
        var o = !1, i = n(16)(n(67), n(201), r, "data-v-7a63e4b3", null);
        i.options.__file = "D:\\work\\songwang\\yuangongji\\mavonEditor\\src\\mavon-editor.vue", i.esModule && Object.keys(i.esModule).some(function (e) {
            return "default" !== e && "__" !== e.substr(0, 2)
        ...
        var _typeof2 = __webpack_require__(18), _typeof3 = _interopRequireDefault(_typeof2),
            _autoTextarea = __webpack_require__(63), _keydownListen = __webpack_require__(72),
            _langHljsCss = __webpack_require__(70), _langHljsCss2 = _interopRequireDefault(_langHljsCss),
            _extraFunction = __webpack_require__(38), _util = __webpack_require__(77),
            _toolbar_left_click2 = __webpack_require__(75), _toolbar_right_click2 = __webpack_require__(76),
            _config = __webpack_require__(69), _markdown = __webpack_require__(74),
            _markdown2 = _interopRequireDefault(_markdown), _mdToolbarLeft = __webpack_require__(36),
            _mdToolbarLeft2 = _interopRequireDefault(_mdToolbarLeft), _mdToolbarRight = __webpack_require__(37),
            _mdToolbarRight2 = _interopRequireDefault(_mdToolbarRight);
        __webpack_require__(115), __webpack_require__(114), exports.default = {
                ...
                return {
                    ...
                    s_external_link: {
                        markdown_css: function () {
                            ...
                            return "https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.3.1/languages/" + e + ".min.js"
                        }, hljs_css: function (e) {
                            return _langHljsCss2.default[e] ? "https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.3.1/styles/" + e + ".min.css" : ""
                        }, katex_js: function () {
            ...
            methods: {
                loadExternalLink: function (e, t, n) {
                    if ("function" != typeof this.p_external_link[e]) return void (!1 !== this.p_external_link[e] && console.error("external_link." + e, "is not a function, if you want to disabled this error log, set external_link." + e, "to function or false"));
                    ...
                    if (t = t || !1, "function" != typeof this.p_external_link.hljs_css) return void (!1 !== this.p_external_link.hljs_css && console.error("external_link.hljs_css is not a function, if you want to disabled this error log, set external_link.hljs_css to function or false"));
                    ...
                    this.$render(t.d_value, function (n) {
                        t.d_render = n, e || t.change && t.change(t.d_value, t.d_render), t.s_navigation && (0, _extraFunction.getNavigation)(t, !1), t.$emit("input", t.d_value), t.d_value !== t.d_history[t.d_history_index] && (window.clearTimeout(t.currentTimeout), t.currentTimeout = setTimeout(function () {
                            t.saveHistory()
                        }, 500))
                    })
        ...
        var o = n(193), i = r(o), a = n(194), s = r(a), l = n(188), c = r(l), u = n(189), p = r(u), d = n(191),
            h = r(d), f = n(192), _ = r(f), g = n(187), m = r(g), b = n(190), v = r(b), k = n(217), w = r(k),
            x = n(218), y = r(x), C = n(212), T = r(C), A = n(213), S = r(A), D = n(215), E = r(D), L = n(216),
            j = r(L), q = n(211), F = r(q), $ = n(214), z = r($);
        t.CONFIG = {
        ...
        function o(e, t) {
            for (var n = void 0, r = void 0, i = 0; i < e.length; i++) -1 !== t.indexOf(e[i].type) && (n = e[i].content, r = e[i].children, e[i].content = a.process(n), r && r.length && n !== e[i].content && o(r, ["html_inline"]))
        }

        Object.defineProperty(t, "__esModule", {value: !0}), t.default = function (e, t) {
            e.options.html && (a = new i.FilterXSS(t), e.core.ruler.push("mavoneditor_sanitizer", r))
        };
        ...
        function o() {
            var e = new h(d), t = e.renderer.rules.link_open || function (e, t, n, r, o) {
                return o.renderToken(e, t, n)
            };
            return e.renderer.rules.link_open = function (e, n, r, o, i) {
                var a = e[n].attrIndex("href");
                if (e[n].attrs[a][1].startsWith("#")) return t(e, n, r, o, i);
                var s = e[n].attrIndex("target");
                return s < 0 ? e[n].attrPush(["target", "_blank"]) : e[n].attrs[s][1] = "_blank", t(e, n, r, o, i)
            }, e.use(T, L).use(f).use(g).use(_).use(y).use(y, "hljs-left").use(y, "hljs-center").use(y, "hljs-right").use(m).use(b).use(v).use(k).use(w).use(y).use(S).use(A).use(x).use(C), e
        }

        Object.defineProperty(t, "__esModule", {value: !0});
        var i = n(18), a = r(i);
        t.initMarkdown = o;
        var s = n(71), l = r(s), c = n(38), u = n(73), p = r(u),
            d = {html: !0, xhtmlOut: !0, breaks: !0, langPrefix: "lang-", linkify: !1, typographer: !0, quotes: "“”‘’"},
            h = n(137), f = n(121), _ = n(133), g = n(134), m = n(120), b = n(118), v = n(127), k = n(130), w = n(132),
            x = n(135), y = n(119), C = n(136), T = n(128), A = n(131), S = n(129), D = {}, E = [], L = {
        ...
        t.default = {
            data: function () {
                ...
                this.markdownIt = o(), this.html ? "object" === (0, a.default)(this.xssOptions) && this.markdownIt.use(p.default, this.xssOptions) : (this.markdownIt.set({html: !1}), this.xssOptions = !1)
            }, mounted: function () {
        ...
        function r(e, t) {
            for (var n in t) {
                ...
                !e[n] || "Object" !== o && "object" !== o ? e[n] = t[n] : e[n] = r(e[n], t[n])
            }
            return e
        }

        function o() {
            var e = window.location.search, t = {}, n = /[?&][^?&]+=[^?&]+/g, r = e.match(n);
            return r && r.forEach(function (e) {
                var n = e.substring(1).split("="), r = decodeURIComponent(n[0]), o = decodeURIComponent(n[1]);
                t[r] = o
            }), t
        }
        ...
        "use strict";
        var r = n(1), o = n(2), i = n(3), a = n(41), s = n(48), l = n(92).KEY, c = n(11), u = n(26), p = n(24),
            d = n(14), h = n(7), f = n(30), _ = n(29), g = n(86), m = n(89), b = n(9), v = n(8), k = n(49), w = n(6),
            x = n(28), y = n(13), C = n(44), T = n(95), A = n(94), S = n(46), D = n(5), E = n(22), L = A.f, j = D.f,
            q = T.f, F = r.Symbol, $ = r.JSON, z = $ && $.stringify, M = h("_hidden"), I = h("toPrimitive"),
            O = {}.propertyIsEnumerable, R = u("symbol-registry"), N = u("symbols"), B = u("op-symbols"),
            H = Object.prototype, P = "function" == typeof F && !!S.f, W = r.QObject,
            U = !W || !W.prototype || !W.prototype.findChild, V = i && c(function () {
                return 7 != C(j({}, "a", {
                    get: function () {
                ...
                return t._k = e, t
            }, K = P && "symbol" == typeof F.iterator ? function (e) {
                return "symbol" == typeof e
            } : function (e) {
                return e instanceof F
            }, Z = function (e, t, n) {
                return e === H && Z(B, t, n), b(e), t = x(t, !0), b(n), o(N, t) ? (n.enumerable ? (o(e, M) && e[M][t] && (e[M][t] = !1), n = C(n, {enumerable: y(0, !1)})) : (o(e, M) || j(e, M, y(1, {})), e[M][t] = !0), V(e, t, n)) : j(e, t, n)
            }, X = function (e, t) {
                b(e);
                ...
                return !(this === H && o(N, e) && !o(B, e)) && (!(t || !o(this, e) || !o(N, e) || o(this, M) && this[M][e]) || t)
            }, Y = function (e, t) {
                ...
                for (var t, n = q(w(e)), r = [], i = 0; n.length > i;) o(N, t = n[i++]) || t == M || t == l || r.push(t);
                return r
            }, te = function (e) {
                for (var t, n = e === H, r = q(n ? B : w(e)), i = [], a = 0; r.length > a;) !o(N, t = r[a++]) || n && !o(H, t) || i.push(N[t]);
                return i
            };
        P || (F = function () {
            if (this instanceof F) throw TypeError("Symbol is not a constructor!");
            var e = d(arguments.length > 0 ? arguments[0] : void 0), t = function (n) {
                this === H && t.call(B, n), o(this, M) && o(this[M], e) && (this[M][e] = !1), V(this, e, y(1, n))
            };
            return i && U && V(H, e, {configurable: !0, set: t}), G(e)
        }, s(F.prototype, "toString", function () {
            return this._k
        }), A.f = Y, D.f = Z, n(45).f = T.f = ee, n(23).f = Q, S.f = te, i && !n(12) && s(H, "propertyIsEnumerable", Q, !0), f.f = function (e) {
            return G(h(e))
        ...
        a(a.S + a.F * ae, "Object", {
            ...
            stringify: function (e) {
                ...
                if (n = t = r[1], (v(t) || void 0 !== e) && !K(e)) return m(t) || (t = function (e, t) {
                    if ("function" == typeof n && (t = n.call(this, e, t)), !K(t)) return t
                }), r[1] = t, z.apply($, r)
            }
        }), F.prototype[I] || n(4)(F.prototype, I, F.prototype.valueOf), p(F, "Symbol"), p(Math, "Math", !0), p(r.JSON, "JSON", !0)
    }, function (e, t, n) {
        n(29)("asyncIterator")
    }, function (e, t, n) {
        n(29)("observable")
        ...
        function f(e) {
            ...
            var o = e.re = n(117)(e.__opts__), u = e.__tlds__.slice();
            ...
            e.__compiled__ = {}, Object.keys(e.__schemas__).forEach(function (t) {
                ...
                if (null !== n) {
                    ...
                    return e.__compiled__[t] = o, a(n) ? (s(n.validate) ? o.validate = d(n.validate) : l(n.validate) ? o.validate = n.validate : r(t, n), void (l(n.normalize) ? o.normalize = n.normalize : n.normalize ? r(t, n) : o.normalize = h())) : i(n) ? void f.push(t) : void r(t, n)
                }
            ...
            e.re.schema_test = RegExp("(^|(?!_)(?:[><｜]|" + o.src_ZPCc + "))(" + _ + ")", "i"), e.re.schema_search = RegExp("(^|(?!_)(?:[><｜]|" + o.src_ZPCc + "))(" + _ + ")", "ig"), e.re.pretest = RegExp("(" + e.re.schema_test.source + ")|(" + e.re.host_fuzzy_test.source + ")|@", "i"), p(e)
        }
        ...
        function m(e, t) {
            ...
            t || u(e) && (t = e, e = {}), this.__opts__ = r({}, b, t), this.__index__ = -1, this.__last_index__ = -1, this.__schema__ = "", this.__text_cache__ = "", this.__schemas__ = r({}, v, e), this.__compiled__ = {}, this.__tlds__ = w, this.__tlds_replaced__ = !1, this.re = {}, f(this)
        }
        ...
        e.exports = function (e) {
            var t = {};
            t.src_Any = n(59).source, t.src_Cc = n(57).source, t.src_Z = n(58).source, t.src_P = n(34).source, t.src_ZPCc = [t.src_Z, t.src_P, t.src_Cc].join("|"), t.src_ZCc = [t.src_Z, t.src_Cc].join("|");
        ...
        e.exports = function (e) {
            ...
            function n(e) {
                var t, n, l, c, u, p, d, h, f, _, g, m, b, v = e.tokens;
                if (e.env.abbreviations) for (m = new RegExp("(?:" + Object.keys(e.env.abbreviations).map(function (e) {
                    return e.substr(1)
                }).sort(function (e, t) {
                    return t.length - e.length
                }).map(r).join("|") + ")"), g = "(^|" + a + "|" + s + "|[" + i.split("").map(r).join("") + "])(" + Object.keys(e.env.abbreviations).map(function (e) {
                    return e.substr(1)
                }).sort(function (e, t) {
                    return t.length - e.length
                }).map(r).join("|") + ")($|" + a + "|" + s + "|[" + i.split("").map(r).join("") + "])", f = new RegExp(g, "g"), n = 0, l = v.length; n < l; n++) if ("inline" === v[n].type) for (c = v[n].children, t = c.length - 1; t >= 0; t--) if (b = c[t], "text" === b.type && (h = 0, p = b.content, f.lastIndex = 0, d = [], m.test(p))) {
                    for (; _ = f.exec(p);) (_.index > 0 || _[1].length > 0) && (u = new e.Token("text", "", 0), u.content = p.slice(h, _.index + _[1].length), d.push(u)), u = new e.Token("abbr_open", "abbr", 1), u.attrs = [["title", e.env.abbreviations[":" + _[2]]]], d.push(u), u = new e.Token("text", "", 0), u.content = _[2], d.push(u), u = new e.Token("abbr_close", "abbr", -1), d.push(u), f.lastIndex -= _[3].length, h = f.lastIndex;
                    d.length && (h < p.length && (u = new e.Token("text", "", 0), u.content = p.slice(h), d.push(u)), v[n].children = c = o(c, t, d))
                }
            }
        ...
        e.exports = function (e, t, n) {
            ...
            function i(e, n, r, o) {
                var i, p, d, h, f, _, g, m, b = !1, v = e.bMarks[n] + e.tShift[n], k = e.eMarks[n];
                if (l !== e.src.charCodeAt(v)) return !1;
                for (i = v + 1; i <= k && s[(i - v) % c] === e.src[i]; i++) ;
                if ((d = Math.floor((i - v) / c)) < a) return !1;
                if (i -= (i - v) % c, h = e.src.slice(v, i), f = e.src.slice(i, k), !u(f)) return !1;
                if (o) return !0;
                for (p = n; !(++p >= r) && (v = e.bMarks[p] + e.tShift[p], k = e.eMarks[p], !(v < k && e.sCount[p] < e.blkIndent));) if (l === e.src.charCodeAt(v) && !(e.sCount[p] - e.blkIndent >= 4)) {
                    for (i = v + 1; i <= k && s[(i - v) % c] === e.src[i]; i++) ;
                    if (!(Math.floor((i - v) / c) < d || (i -= (i - v) % c, (i = e.skipSpaces(i)) < k))) {
                        b = !0;
                        break
                    }
                }
                return g = e.parentType, m = e.lineMax, e.parentType = "container", e.lineMax = p, _ = e.push("container_" + t + "_open", "div", 1), _.markup = h, _.block = !0, _.info = f, _.map = [n, p], e.md.block.tokenize(e, n + 1, p), _ = e.push("container_" + t + "_close", "div", -1), _.markup = e.src.slice(v, i), _.block = !0, e.parentType = g, e.lineMax = m, e.line = p + (b ? 1 : 0), !0
            }
        ...
        e.exports = function (e) {
            ...
            function r(e, r, i, a) {
                ...
                h = e.tokens.length, T = !0, A = e.push("dl_open", "dl", 1), A.map = d = [r, 0], u = r, c = _;
                e:for (; ;) {
                    for (C = !1, A = e.push("dt_open", "dt", 1), A.map = [u, u], A = e.push("inline", "", 0), A.map = [u, u], A.content = e.getLines(u, u + 1, e.blkIndent, !1).trim(), A.children = [], A = e.push("dt_close", "dt", -1); ;) {
                        for (A = e.push("dd_open", "dd", 1), A.map = p = [_, 0], y = l, f = e.eMarks[c], g = e.sCount[c] + l - (e.bMarks[c] + e.tShift[c]); y < f && (s = e.src.charCodeAt(y), o(s));) 9 === s ? g += 4 - g % 4 : g++, y++;
                        if (l = y, x = e.tight, m = e.ddIndent, b = e.blkIndent, w = e.tShift[c], k = e.sCount[c], v = e.parentType, e.blkIndent = e.ddIndent = e.sCount[c] + 2, e.tShift[c] = l - e.bMarks[c], e.sCount[c] = g, e.tight = !0, e.parentType = "deflist", e.md.block.tokenize(e, c, i, !0), e.tight && !C || (T = !1), C = e.line - c > 1 && e.isEmpty(e.line - 1), e.tShift[c] = w, e.sCount[c] = k, e.tight = x, e.parentType = v, e.blkIndent = b, e.ddIndent = m, A = e.push("dd_close", "dd", -1), p[1] = _ = e.line, _ >= i) break e;
                ...
                return A = e.push("dl_close", "dl", -1), d[1] = _, e.line = _, T && n(e, h), !0
            }
        ...
        e.exports = function (e) {
            function t(e, t, n, r) {
                var o, i, a, s, l, c, u, p, d, h, _, g = e.bMarks[t] + e.tShift[t], m = e.eMarks[t];
                if (g + 4 > m) return !1;
                ...
                if (r) return !0;
                for (l++, e.env.footnotes || (e.env.footnotes = {}), e.env.footnotes.refs || (e.env.footnotes.refs = {}), c = e.src.slice(g + 2, l - 2), e.env.footnotes.refs[":" + c] = -1, u = new e.Token("footnote_reference_open", "", 1), u.meta = {label: c}, u.level = e.level++, e.tokens.push(u), o = e.bMarks[t], i = e.tShift[t], a = e.sCount[t], s = e.parentType, _ = l, p = d = e.sCount[t] + l - (e.bMarks[t] + e.tShift[t]); l < m && (h = e.src.charCodeAt(l), f(h));) 9 === h ? d += 4 - d % 4 : d++, l++;
                return e.tShift[t] = l - _, e.sCount[t] = d - p, e.bMarks[t] = _, e.blkIndent += 4, e.parentType = "footnote", e.sCount[t] < e.blkIndent && (e.sCount[t] += e.blkIndent), e.md.block.tokenize(e, t, n, !0), e.parentType = s, e.blkIndent -= 4, e.tShift[t] = i, e.sCount[t] = a, e.bMarks[t] = o, u = new e.Token("footnote_reference_close", "", -1), u.level = --e.level, e.tokens.push(u), !0
            }

            function n(e, t) {
                var n, r, o, i, a, s = e.posMax, l = e.pos;
                return !(l + 2 >= s) && (94 === e.src.charCodeAt(l) && (91 === e.src.charCodeAt(l + 1) && (n = l + 2, !((r = h(e, l + 1)) < 0) && (t || (e.env.footnotes || (e.env.footnotes = {}), e.env.footnotes.list || (e.env.footnotes.list = []), o = e.env.footnotes.list.length, e.md.inline.parse(e.src.slice(n, r), e.md, e.env, a = []), i = e.push("footnote_ref", "", 0), i.meta = {id: o}, e.env.footnotes.list[o] = {
            ...
            var h = e.helpers.parseLinkLabel, f = e.utils.isSpace;
            e.renderer.rules.footnote_ref = i, e.renderer.rules.footnote_block_open = a, e.renderer.rules.footnote_block_close = s, e.renderer.rules.footnote_open = l, e.renderer.rules.footnote_close = c, e.renderer.rules.footnote_anchor = u, e.renderer.rules.footnote_caption = o, e.renderer.rules.footnote_anchor_name = r, e.block.ruler.before("reference", "footnote_def", t, {alt: ["paragraph", "reference"]}), e.inline.ruler.after("image", "footnote_inline", n), e.inline.ruler.after("footnote_inline", "footnote_ref", p), e.core.ruler.after("inline", "footnote_tail", d)
        }
    }, function (e, t) {
        var n = function (e, t) {
        ...
        function i(e, t) {
            if (e.children.unshift(a(e, t)), e.children[1].content = e.children[1].content.slice(3), e.content = e.content.slice(3), _) if (g) {
                e.children.pop();
        ...
        function a(e, t) {
            var n = new t("html_inline", "", 0), r = f ? ' disabled="" ' : "";
        ...
        var f = !0, _ = !1, g = !1;
        e.exports = function (e, t) {
            t && (f = !t.enabled, _ = !!t.label, g = !!t.labelAfter), e.core.ruler.after("inline", "github-task-lists", function (e) {
                for (var t = e.tokens, a = 2; a < t.length; a++) o(t, a) && (i(t[a], e.Token), n(t[a - 2], "class", "task-list-item" + (f ? "" : " enabled")), n(t[r(t, a - 2)], "class", "contains-task-list"))
            })
        }
    }, function (e, t, n) {
        "use strict";
        ...
        function a(e, t) {
            ...
            t || s.isString(e) || (t = e || {}, e = "default"), this.inline = new d, this.block = new p, this.core = new u, this.renderer = new c, this.linkify = new h, this.validateLink = r, this.normalizeLink = o, this.normalizeLinkText = i, this.utils = s, this.helpers = s.assign({}, l), this.options = {}, this.configure(e), t && this.set(t)
        }

        var s = n(0), l = n(139), c = n(150), u = n(145), p = n(144), d = n(146), h = n(116), f = n(56), _ = n(186),
            g = {default: n(148), zero: n(149), commonmark: n(147)}, m = /^(vbscript|javascript|file|data):/,
        ...
        a.prototype.set = function (e) {
            ...
            var t, n = this;
            if (s.isString(e) && (t = e, !(e = g[t]))) throw new Error('Wrong `markdown-it` preset "' + t + '", check name');
        ...
        var o = n(32),
            i = [["normalize", n(166)], ["block", n(163)], ["inline", n(164)], ["linkify", n(165)], ["replacements", n(167)], ["smartquotes", n(168)]];
        ...
        var o = n(32),
            i = [["text", n(180)], ["newline", n(178)], ["escape", n(174)], ["backticks", n(171)], ["strikethrough", n(55).tokenize], ["emphasis", n(54).tokenize], ["link", n(177)], ["image", n(176)], ["autolink", n(170)], ["html_inline", n(175)], ["entity", n(173)]],
            a = [["balance_pairs", n(172)], ["strikethrough", n(55).postProcess], ["emphasis", n(54).postProcess], ["text_collapse", n(181)]];
        ...
        var r = n(0).isSpace;
        e.exports = function (e, t, n, o) {
            var i, a, s, l, c, u, p, d, h, f, _, g, m, b, v, k, w, x, y, C, T = e.lineMax,
                A = e.bMarks[t] + e.tShift[t], S = e.eMarks[t];
            if (e.sCount[t] - e.blkIndent >= 4) return !1;
            if (62 !== e.src.charCodeAt(A++)) return !1;
            if (o) return !0;
            for (l = h = e.sCount[t] + A - (e.bMarks[t] + e.tShift[t]), 32 === e.src.charCodeAt(A) ? (A++, l++, h++, i = !1, k = !0) : 9 === e.src.charCodeAt(A) ? (k = !0, (e.bsCount[t] + h) % 4 == 3 ? (A++, l++, h++, i = !1) : i = !0) : k = !1, f = [e.bMarks[t]], e.bMarks[t] = A; A < S && (a = e.src.charCodeAt(A), r(a));) 9 === a ? h += 4 - (h + e.bsCount[t] + (i ? 1 : 0)) % 4 : h++, A++;
            for (_ = [e.bsCount[t]], e.bsCount[t] = e.sCount[t] + 1 + (k ? 1 : 0), u = A >= S, b = [e.sCount[t]], e.sCount[t] = h - l, v = [e.tShift[t]], e.tShift[t] = A - e.bMarks[t], x = e.md.block.ruler.getRules("blockquote"), m = e.parentType, e.parentType = "blockquote", C = !1, d = t + 1; d < n && (e.sCount[d] < e.blkIndent && (C = !0), A = e.bMarks[d] + e.tShift[d], S = e.eMarks[d], !(A >= S)); d++) if (62 !== e.src.charCodeAt(A++) || C) {
                if (u) break;
                ...
                if (w) {
                    e.lineMax = d, 0 !== e.blkIndent && (f.push(e.bMarks[d]), _.push(e.bsCount[d]), v.push(e.tShift[d]), b.push(e.sCount[d]), e.sCount[d] -= e.blkIndent);
                    break
                }
                f.push(e.bMarks[d]), _.push(e.bsCount[d]), v.push(e.tShift[d]), b.push(e.sCount[d]), e.sCount[d] = -1
            } else {
                for (l = h = e.sCount[d] + A - (e.bMarks[d] + e.tShift[d]), 32 === e.src.charCodeAt(A) ? (A++, l++, h++, i = !1, k = !0) : 9 === e.src.charCodeAt(A) ? (k = !0, (e.bsCount[d] + h) % 4 == 3 ? (A++, l++, h++, i = !1) : i = !0) : k = !1, f.push(e.bMarks[d]), e.bMarks[d] = A; A < S && (a = e.src.charCodeAt(A), r(a));) 9 === a ? h += 4 - (h + e.bsCount[d] + (i ? 1 : 0)) % 4 : h++, A++;
                u = A >= S, _.push(e.bsCount[d]), e.bsCount[d] = e.sCount[d] + 1 + (k ? 1 : 0), b.push(e.sCount[d]), e.sCount[d] = h - l, v.push(e.tShift[d]), e.tShift[d] = A - e.bMarks[d]
            }
            for (g = e.blkIndent, e.blkIndent = 0, y = e.push("blockquote_open", "blockquote", 1), y.markup = ">", y.map = p = [t, 0], e.md.block.tokenize(e, t, d), y = e.push("blockquote_close", "blockquote", -1), y.markup = ">", e.lineMax = T, e.parentType = m, p[1] = e.line, s = 0; s < v.length; s++) e.bMarks[s + t] = f[s], e.tShift[s + t] = v[s], e.sCount[s + t] = b[s], e.bsCount[s + t] = _[s];
        ...
        e.exports = function (e, t, n, r) {
            var o, i, a, s, l, c, u, p = !1, d = e.bMarks[t] + e.tShift[t], h = e.eMarks[t];
            if (e.sCount[t] - e.blkIndent >= 4) return !1;
            if (d + 3 > h) return !1;
            if (126 !== (o = e.src.charCodeAt(d)) && 96 !== o) return !1;
            if (l = d, d = e.skipChars(d, o), (i = d - l) < 3) return !1;
            if (u = e.src.slice(l, d), a = e.src.slice(d, h), 96 === o && a.indexOf(String.fromCharCode(o)) >= 0) return !1;
            if (r) return !0;
            for (s = t; !(++s >= n) && (d = l = e.bMarks[s] + e.tShift[s], h = e.eMarks[s], !(d < h && e.sCount[s] < e.blkIndent));) if (e.src.charCodeAt(d) === o && !(e.sCount[s] - e.blkIndent >= 4 || (d = e.skipChars(d, o)) - l < i || (d = e.skipSpaces(d)) < h)) {
                p = !0;
                break
            }
        ...
        "use strict";
        var r = n(138), o = n(53).HTML_OPEN_CLOSE_TAG_RE,
        ...
        "use strict";
        e.exports = function (e, t, n) {
            var r, o, i, a, s, l, c, u, p, d, h = t + 1, f = e.md.block.ruler.getRules("paragraph");
            if (e.sCount[t] - e.blkIndent >= 4) return !1;
            for (d = e.parentType, e.parentType = "paragraph"; h < n && !e.isEmpty(h); h++) if (!(e.sCount[h] - e.blkIndent > 3)) {
                if (e.sCount[h] >= e.blkIndent && (l = e.bMarks[h] + e.tShift[h], c = e.eMarks[h], l < c && (45 === (p = e.src.charCodeAt(l)) || 61 === p) && (l = e.skipChars(l, p), (l = e.skipSpaces(l)) >= c))) {
                    u = 61 === p ? 1 : 2;
                    break
                }
                if (!(e.sCount[h] < 0)) {
                    for (o = !1, i = 0, a = f.length; i < a; i++) if (f[i](e, h, n, !0)) {
                        o = !0;
                        break
                    }
                    if (o) break
            ...
            return !!u && (r = e.getLines(t, h, e.blkIndent, !1).trim(), e.line = h + 1, s = e.push("heading_open", "h" + String(u), 1), s.markup = String.fromCharCode(p), s.map = [t, e.line], s = e.push("inline", "", 0), s.content = r, s.map = [t, e.line - 1], s.children = [], s = e.push("heading_close", "h" + String(u), -1), s.markup = String.fromCharCode(p), e.parentType = d, !0)
        }
    }, function (e, t, n) {
        "use strict";
        ...
        e.exports = function (e, t, n, a) {
            var s, l, c, u, p, d, h, f, _, g, m, b, v, k, w, x, y, C, T, A, S, D, E, L, j, q, F, $, z = !1, M = !0;
            if (e.sCount[t] - e.blkIndent >= 4) return !1;
            if (e.listIndent >= 0 && e.sCount[t] - e.listIndent >= 4 && e.sCount[t] < e.blkIndent) return !1;
            if (a && "paragraph" === e.parentType && e.tShift[t] >= e.blkIndent && (z = !0), (E = o(e, t)) >= 0) {
                if (h = !0, j = e.bMarks[t] + e.tShift[t], v = Number(e.src.substr(j, E - j - 1)), z && 1 !== v) return !1
            } else {
            ...
            for (m = e.tokens.length, h ? ($ = e.push("ordered_list_open", "ol", 1), 1 !== v && ($.attrs = [["start", v]])) : $ = e.push("bullet_list_open", "ul", 1), $.map = g = [t, 0], $.markup = String.fromCharCode(b), w = t, L = !1, F = e.md.block.ruler.getRules("list"), C = e.parentType, e.parentType = "list"; w < n;) {
                for (D = E, k = e.eMarks[w], d = x = e.sCount[w] + E - (e.bMarks[t] + e.tShift[t]); D < k;) {
                    if (9 === (s = e.src.charCodeAt(D))) x += 4 - (x + e.bsCount[w]) % 4; else {
                        if (32 !== s) break;
                        x++
                    }
                    D++
                }
                if (l = D, p = l >= k ? 1 : x - d, p > 4 && (p = 1), u = d + p, $ = e.push("list_item_open", "li", 1), $.markup = String.fromCharCode(b), $.map = f = [t, 0], S = e.tight, A = e.tShift[t], T = e.sCount[t], y = e.listIndent, e.listIndent = e.blkIndent, e.blkIndent = u, e.tight = !0, e.tShift[t] = l - e.bMarks[t], e.sCount[t] = x, l >= k && e.isEmpty(t + 1) ? e.line = Math.min(e.line + 2, n) : e.md.block.tokenize(e, t, n, !0), e.tight && !L || (M = !1), L = e.line - t > 1 && e.isEmpty(e.line - 1), e.blkIndent = e.listIndent, e.listIndent = y, e.tShift[t] = A, e.sCount[t] = T, e.tight = S, $ = e.push("list_item_close", "li", -1), $.markup = String.fromCharCode(b), w = t = e.line, f[1] = w, l = e.bMarks[t], w >= n) break;
                if (e.sCount[w] < e.blkIndent) break;
                if (e.sCount[t] - e.blkIndent >= 4) break;
                for (q = !1, c = 0, _ = F.length; c < _; c++) if (F[c](e, w, n, !0)) {
                    q = !0;
                    break
                }
                if (q) break;
            ...
            return $ = h ? e.push("ordered_list_close", "ol", -1) : e.push("bullet_list_close", "ul", -1), $.markup = String.fromCharCode(b), g[1] = w, e.line = w, e.parentType = C, M && i(e, m), !0
        }
    }, function (e, t, n) {
        "use strict";
        e.exports = function (e, t) {
        ...
        e.exports = function (e, t, n, i) {
            var a, s, l, c, u, p, d, h, f, _, g, m, b, v, k, w, x = 0, y = e.bMarks[t] + e.tShift[t], C = e.eMarks[t],
                T = t + 1;
            if (e.sCount[t] - e.blkIndent >= 4) return !1;
            ...
            for (c = e.lineMax, k = e.md.block.ruler.getRules("reference"), _ = e.parentType, e.parentType = "reference"; T < c && !e.isEmpty(T); T++) if (!(e.sCount[T] - e.blkIndent > 3 || e.sCount[T] < 0)) {
                for (v = !1, p = 0, d = k.length; p < d; p++) if (k[p](e, T, c, !0)) {
                    v = !0;
                    break
                }
                if (v) break
            }
            for (b = e.getLines(t, T, e.blkIndent, !1).trim(), C = b.length, y = 1; y < C; y++) {
            ...
            for (y = f + 2; y < C; y++) if (10 === (a = b.charCodeAt(y))) x++; else if (!o(a)) break;
            if (g = e.md.helpers.parseLinkDestination(b, y, C), !g.ok) return !1;
            if (u = e.md.normalizeLink(g.str), !e.md.validateLink(u)) return !1;
            for (y = g.pos, x += g.lines, s = y, l = x, m = y; y < C; y++) if (10 === (a = b.charCodeAt(y))) x++; else if (!o(a)) break;
            for (g = e.md.helpers.parseLinkTitle(b, y, C), y < C && m !== y && g.ok ? (w = g.str, y = g.pos, x += g.lines) : (w = "", y = s, x = l); y < C && (a = b.charCodeAt(y), o(a));) y++;
            if (y < C && 10 !== b.charCodeAt(y) && w) for (w = "", y = s, x = l; y < C && (a = b.charCodeAt(y), o(a));) y++;
            return !(y < C && 10 !== b.charCodeAt(y)) && (!!(h = r(b.slice(1, f))) && (!!i || (void 0 === e.env.references && (e.env.references = {}), void 0 === e.env.references[h] && (e.env.references[h] = {
                title: w,
                href: u
            }), e.parentType = _, e.line = t + x + 1, !0)))
        }
    }, function (e, t, n) {
        "use strict";
        ...
        function r(e, t, n, r) {
            var o, a, s, l, c, u, p, d;
            for (this.src = e, this.md = t, this.env = n, this.tokens = r, this.bMarks = [], this.eMarks = [], this.tShift = [], this.sCount = [], this.bsCount = [], this.blkIndent = 0, this.line = 0, this.lineMax = 0, this.tight = !1, this.ddIndent = -1, this.listIndent = -1, this.parentType = "root", this.level = 0, this.result = "", a = this.src, d = !1, s = l = u = p = 0, c = a.length; l < c; l++) {
        ...
        e.exports = function (e, t, n, a) {
            ...
            if (e.sCount[t] - e.blkIndent >= 4) return !1;
            if (d = o(l.replace(/^\||\|$/g, "")), (h = d.length) > _.length) return !1;
            if (a) return !0;
            for (f = e.push("table_open", "table", 1), f.map = m = [t, 0], f = e.push("thead_open", "thead", 1), f.map = [t, t + 1], f = e.push("tr_open", "tr", 1), f.map = [t, t + 1], u = 0; u < d.length; u++) f = e.push("th_open", "th", 1), f.map = [t, t + 1], _[u] && (f.attrs = [["style", "text-align:" + _[u]]]), f = e.push("inline", "", 0), f.content = d[u].trim(), f.map = [t, t + 1], f.children = [], f = e.push("th_close", "th", -1);
            for (f = e.push("tr_close", "tr", -1), f = e.push("thead_close", "thead", -1), f = e.push("tbody_open", "tbody", 1), f.map = b = [t + 2, 0], p = t + 2; p < n && !(e.sCount[p] < e.blkIndent) && (l = r(e, p).trim(), -1 !== l.indexOf("|")) && !(e.sCount[p] - e.blkIndent >= 4); p++) {
                for (d = o(l.replace(/^\||\|$/g, "")), f = e.push("tr_open", "tr", 1), u = 0; u < h; u++) f = e.push("td_open", "td", 1), _[u] && (f.attrs = [["style", "text-align:" + _[u]]]), f = e.push("inline", "", 0), f.content = d[u] ? d[u].trim() : "", f.children = [], f = e.push("td_close", "td", -1);
                f = e.push("tr_close", "tr", -1)
            }
            return f = e.push("tbody_close", "tbody", -1), f = e.push("table_close", "table", -1), m[1] = b[1] = p, e.line = p, !0
        }
    }, function (e, t, n) {
        "use strict";
        e.exports = function (e) {
        ...
        e.exports = function (e) {
            var t, n, a, s, l, c, u, p, d, h, f, _, g, m, b, v, k, w = e.tokens;
            if (e.md.options.linkify) for (n = 0, a = w.length; n < a; n++) if ("inline" === w[n].type && e.md.linkify.pretest(w[n].content)) for (s = w[n].children, g = 0, t = s.length - 1; t >= 0; t--) if (c = s[t], "link_close" !== c.type) {
                if ("html_inline" === c.type && (r(c.content) && g > 0 && g--, o(c.content) && g++), !(g > 0) && "text" === c.type && e.md.linkify.test(c.content)) {
                    for (d = c.content, k = e.md.linkify.match(d), u = [], _ = c.level, f = 0, p = 0; p < k.length; p++) m = k[p].url, b = e.md.normalizeLink(m), e.md.validateLink(b) && (v = k[p].text, v = k[p].schema ? "mailto:" !== k[p].schema || /^mailto:/i.test(v) ? e.md.normalizeLinkText(v) : e.md.normalizeLinkText("mailto:" + v).replace(/^mailto:/, "") : e.md.normalizeLinkText("http://" + v).replace(/^http:\/\//, ""), h = k[p].index, h > f && (l = new e.Token("text", "", 0), l.content = d.slice(f, h), l.level = _, u.push(l)), l = new e.Token("link_open", "a", 1), l.attrs = [["href", b]], l.level = _++, l.markup = "linkify", l.info = "auto", u.push(l), l = new e.Token("text", "", 0), l.content = v, l.level = _, u.push(l), l = new e.Token("link_close", "a", -1), l.level = --_, l.markup = "linkify", l.info = "auto", u.push(l), f = k[p].lastIndex);
                    f < d.length && (l = new e.Token("text", "", 0), l.content = d.slice(f), l.level = _, u.push(l)), w[n].children = s = i(s, t, u)
                }
        ...
        function o(e, t) {
            ...
            for (A = [], n = 0; n < e.length; n++) {
                for (o = e[n], f = e[n].level, C = A.length - 1; C >= 0 && !(A[C].level <= f); C--) ;
                if (A.length = C + 1, "text" === o.type) {
                    l = o.content, d = 0, h = l.length;
                    e:for (; d < h && (c.lastIndex = d, p = c.exec(l));) {
                        if (x = y = !0, d = p.index + 1, T = "'" === p[0], g = 32, p.index - 1 >= 0) g = l.charCodeAt(p.index - 1); else for (C = n - 1; C >= 0 && ("softbreak" !== e[C].type && "hardbreak" !== e[C].type); C--) if ("text" === e[C].type) {
                            g = e[C].content.charCodeAt(e[C].content.length - 1);
                            break
                        }
                        if (m = 32, d < h) m = l.charCodeAt(d); else for (C = n + 1; C < e.length && ("softbreak" !== e[C].type && "hardbreak" !== e[C].type); C++) if ("text" === e[C].type) {
                            m = e[C].content.charCodeAt(0);
                            break
                        }
                        if (b = s(g) || a(String.fromCharCode(g)), v = s(m) || a(String.fromCharCode(m)), k = i(g), w = i(m), w ? x = !1 : v && (k || b || (x = !1)), k ? y = !1 : b && (w || v || (y = !1)), 34 === m && '"' === p[0] && g >= 48 && g <= 57 && (y = x = !1), x && y && (x = !1, y = v), x || y) {
                            if (y) for (C = A.length - 1; C >= 0 && (_ = A[C], !(A[C].level < f)); C--) if (_.single === T && A[C].level === f) {
                                _ = A[C], T ? (S = t.md.options.quotes[2], D = t.md.options.quotes[3]) : (S = t.md.options.quotes[0], D = t.md.options.quotes[1]), o.content = r(o.content, p.index, D), e[_.token].content = r(e[_.token].content, _.pos, S), d += D.length - 1, _.token === n && (d += S.length - 1), l = o.content, h = l.length, A.length = C;
                                continue e
                            }
                            x ? A.push({
                                token: n,
        ...
        function r(e, t) {
            ...
            for (n = 0; n < p; n++) if (o = t[n], o.length = o.length || 0, o.close) {
                for (u.hasOwnProperty(o.marker) || (u[o.marker] = [-1, -1, -1]), a = u[o.marker][o.length % 3], s = -1, r = n - o.jump - 1; r > a; r -= i.jump + 1) if (i = t[r], i.marker === o.marker && (-1 === s && (s = r), i.open && i.end < 0 && i.level === o.level && (l = !1, (i.close || o.open) && (i.length + o.length) % 3 == 0 && (i.length % 3 == 0 && o.length % 3 == 0 || (l = !0)), !l))) {
        ...
        "use strict";
        var r = n(52), o = n(0).has, i = n(0).isValidEntityCode, a = n(0).fromCodePoint,
        ...
        var r = n(0).normalizeReference, o = n(0).isSpace;
        e.exports = function (e, t) {
            var n, i, a, s, l, c, u, p, d, h, f, _, g, m = "", b = e.pos, v = e.posMax;
            ...
            if ((u = l + 1) < v && 40 === e.src.charCodeAt(u)) {
                ...
                if (u >= v) return !1;
                for (g = u, d = e.md.helpers.parseLinkDestination(e.src, u, e.posMax), d.ok && (m = e.md.normalizeLink(d.str), e.md.validateLink(m) ? u = d.pos : m = ""), g = u; u < v && (i = e.src.charCodeAt(u), o(i) || 10 === i); u++) ;
                if (d = e.md.helpers.parseLinkTitle(e.src, u, e.posMax), u < v && g !== u && d.ok) for (h = d.str, u = d.pos; u < v && (i = e.src.charCodeAt(u), o(i) || 10 === i); u++) ; else h = "";
                if (u >= v || 41 !== e.src.charCodeAt(u)) return e.pos = b, !1;
                u++
            } else {
                if (void 0 === e.env.references) return !1;
                if (u < v && 91 === e.src.charCodeAt(u) ? (g = u + 1, u = e.md.helpers.parseLinkLabel(e, u), u >= 0 ? s = e.src.slice(g, u++) : u = l + 1) : u = l + 1, s || (s = e.src.slice(c, l)), !(p = e.env.references[r(s)])) return e.pos = b, !1;
                m = p.href, h = p.title
            }
            return t || (a = e.src.slice(c, l), e.md.inline.parse(a, e.md, e.env, _ = []), f = e.push("image", "img", 0), f.attrs = n = [["src", m], ["alt", ""]], f.children = _, f.content = a, h && n.push(["title", h])), e.pos = u, e.posMax = v, !0
        }
    }, function (e, t, n) {
        "use strict";
        var r = n(0).normalizeReference, o = n(0).isSpace;
        e.exports = function (e, t) {
            var n, i, a, s, l, c, u, p, d, h, f = "", _ = e.pos, g = e.posMax, m = e.pos, b = !0;
            if (91 !== e.src.charCodeAt(e.pos)) return !1;
            if (l = e.pos + 1, (s = e.md.helpers.parseLinkLabel(e, e.pos, !0)) < 0) return !1;
            if ((c = s + 1) < g && 40 === e.src.charCodeAt(c)) {
                for (b = !1, c++; c < g && (i = e.src.charCodeAt(c), o(i) || 10 === i); c++) ;
                if (c >= g) return !1;
                for (m = c, u = e.md.helpers.parseLinkDestination(e.src, c, e.posMax), u.ok && (f = e.md.normalizeLink(u.str), e.md.validateLink(f) ? c = u.pos : f = ""), m = c; c < g && (i = e.src.charCodeAt(c), o(i) || 10 === i); c++) ;
                if (u = e.md.helpers.parseLinkTitle(e.src, c, e.posMax), c < g && m !== c && u.ok) for (d = u.str, c = u.pos; c < g && (i = e.src.charCodeAt(c), o(i) || 10 === i); c++) ; else d = "";
                (c >= g || 41 !== e.src.charCodeAt(c)) && (b = !0), c++
            }
            if (b) {
                if (void 0 === e.env.references) return !1;
                if (c < g && 91 === e.src.charCodeAt(c) ? (m = c + 1, c = e.md.helpers.parseLinkLabel(e, c), c >= 0 ? a = e.src.slice(m, c++) : c = s + 1) : c = s + 1, a || (a = e.src.slice(l, s)), !(p = e.env.references[r(a)])) return e.pos = _, !1;
                f = p.href, d = p.title
            }
            return t || (e.pos = l, e.posMax = s, h = e.push("link_open", "a", 1), h.attrs = n = [["href", f]], d && n.push(["title", d]), e.md.inline.tokenize(e), h = e.push("link_close", "a", -1)), e.pos = c, e.posMax = g, !0
        }
    }, function (e, t, n) {
        "use strict";
        var r = n(0).isSpace;
        ...
        r.prototype.pushPending = function () {
            ...
            var n, r, o, l, c, u, p, d, h, f = e, _ = !0, g = !0, m = this.posMax, b = this.src.charCodeAt(e);
            for (n = e > 0 ? this.src.charCodeAt(e - 1) : 32; f < m && this.src.charCodeAt(f) === b;) f++;
            return o = f - e, r = f < m ? this.src.charCodeAt(f) : 32, p = s(n) || a(String.fromCharCode(n)), h = s(r) || a(String.fromCharCode(r)), u = i(n), d = i(r), d ? _ = !1 : h && (u || p || (_ = !1)), u ? g = !1 : p && (d || h || (g = !1)), t ? (l = _, c = g) : (l = _ && (!g || p), c = g && (!_ || h)), {
                can_open: l,
                can_close: c,
                length: o
            }
        ...
        var i = /^([a-z0-9.+-]+:)/i, a = /:[0-9]*$/, s = /^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/,
            l = ["<", ">", '"', "`", " ", "\r", "\n", "\t"], c = ["{", "}", "|", "\\", "^", "`"].concat(l),
            u = ["'"].concat(c), p = ["%", "/", "?", ";", "#"].concat(u), d = ["/", "?", "#"],
            h = /^[+a-z0-9A-Z_-]{0,63}$/, f = /^([+a-z0-9A-Z_-]{0,63})(.*)$/, _ = {javascript: !0, "javascript:": !0},
            g = {
                http: !0,
                https: !0,
                ftp: !0,
        ...
        r.prototype.parse = function (e, t) {
            ...
            var m = i.exec(c);
            if (m && (m = m[0], o = m.toLowerCase(), this.protocol = m, c = c.substr(m.length)), (t || m || c.match(/^\/\/[^@\/]+@[^@\/]+/)) && (!(l = "//" === c.substr(0, 2)) || m && _[m] || (c = c.substr(2), this.slashes = !0)), !_[m] && (l || m && !g[m])) {
                var b = -1;
                for (n = 0; n < d.length; n++) -1 !== (a = c.indexOf(d[n])) && (-1 === b || a < b) && (b = a);
                var v, k;
                ...
                if (!x) {
                    ...
                    for (n = 0, r = y.length; n < r; n++) {
                        ...
                        if (C && !C.match(h)) {
                            ...
                            if (!T.match(h)) {
                                var D = y.slice(0, n), E = y.slice(n + 1), L = C.match(f);
                                L && (D.push(L[1]), E.unshift(L[2])), E.length && (c = E.join(".") + c), this.hostname = D.join(".");
                                break
                            }
                        }
                    }
            ...
            var q = c.indexOf("?");
            return -1 !== q && (this.search = c.substr(q), c = c.slice(0, q)), c && (this.pathname = c), g[o] && this.hostname && !this.pathname && (this.pathname = ""), this
        ...
        (function (e, r) {
            ...
            !function (i) {
                ...
                function l(e, t) {
                    var n = e.split("@"), r = "";
                    return n.length > 1 && (r = n[0] + "@", e = n[1]), e = e.replace(j, "."), r + s(e.split("."), t).join(".")
                }
                ...
                function h(e, t, n) {
                    var r = 0;
                    for (e = n ? $(e / T) : e >> 1, e += $(e / t); e > F * y >> 1; r += w) e = $(e / F);
                    return $(r + (F + 1) * e / (e + C))
                }

                function f(e) {
                    var t, n, r, o, i, s, l, c, d, f, _ = [], g = e.length, m = 0, b = S, v = A;
                    for (n = e.lastIndexOf(D), n < 0 && (n = 0), r = 0; r < n; ++r) e.charCodeAt(r) >= 128 && a("not-basic"), _.push(e.charCodeAt(r));
                    for (o = n > 0 ? n + 1 : 0; o < g;) {
                        for (i = m, s = 1, l = w; o >= g && a("invalid-input"), c = p(e.charCodeAt(o++)), (c >= w || c > $((k - m) / s)) && a("overflow"), m += c * s, d = l <= v ? x : l >= v + y ? y : l - v, !(c < d); l += w) f = w - d, s > $(k / f) && a("overflow"), s *= f;
                        t = _.length + 1, v = h(m - i, t, 0 == i), $(m / t) > k - b && a("overflow"), b += $(m / t), m %= t, _.splice(m++, 0, b)
                    }
                    return u(_)
                }

                function _(e) {
                    var t, n, r, o, i, s, l, u, p, f, _, g, m, b, v, C = [];
                    for (e = c(e), g = e.length, t = S, n = 0, i = A, s = 0; s < g; ++s) (_ = e[s]) < 128 && C.push(z(_));
                    for (r = o = C.length, o && C.push(D); r < g;) {
                        for (l = k, s = 0; s < g; ++s) (_ = e[s]) >= t && _ < l && (l = _);
                        for (m = r + 1, l - t > $((k - n) / m) && a("overflow"), n += (l - t) * m, t = l, s = 0; s < g; ++s) if (_ = e[s], _ < t && ++n > k && a("overflow"), _ == t) {
                            for (u = n, p = w; f = p <= i ? x : p >= i + y ? y : p - i, !(u < f); p += w) v = u - f, b = w - f, C.push(z(d(f + v % b, 0))), u = $(v / b);
                ...
                var v, k = 2147483647, w = 36, x = 1, y = 26, C = 38, T = 700, A = 72, S = 128, D = "-", E = /^xn--/,
                    L = /[^\x20-\x7E]/, j = /[\x2E\u3002\uFF0E\uFF61]/g, q = {
                        overflow: "Overflow: input needs wider integers to process",
                        "not-basic": "Illegal input >= 0x80 (not a basic code point)",
                        "invalid-input": "Invalid input"
                    }, F = w - x, $ = Math.floor, z = String.fromCharCode;
                v = {
                    version: "1.4.1",
        ...
        var o = !1, i = n(16)(n(64), n(199), r, null, null);
        ...
        a.prototype.process = function (e) {
            ...
            var t = this, n = t.options, i = n.whiteList, a = n.onTag, s = n.onIgnoreTag, c = n.onTagAttr,
                h = n.onIgnoreTagAttr, f = n.safeAttrValue, _ = n.escapeHtml, g = t.cssFilter;
            ...
            var b = u(e, function (e, t, n, l, u) {
                var m = {sourcePosition: e, position: t, isClosing: u, isWhite: i.hasOwnProperty(n)}, b = a(n, l, m);
                if (!r(b)) return b;
                if (m.isWhite) {
                    if (m.isClosing) return "</" + n + ">";
                    var v = o(l), k = i[n], w = p(v.html, function (e, t) {
                        var o = -1 !== d.indexOf(k, e), i = c(n, e, t, o);
                        if (!r(i)) return i;
                        if (o) return t = f(n, e, t, g), t ? e + '="' + t + '"' : e;
                        var i = h(n, e, t, o);
                        return r(i) ? void 0 : i
                    }), l = "<" + n;
